	...
	<div class="content">
		...
		<div class="navigation">
			...
			<ul class="menu js__accordion">
				...
				<li>
					<a class="waves-effect" href="Deconnexion.php"><i class="menu-icon mdi mdi-calendar"></i><span>Déconnexion</span></a>
				</li>
			</ul>
		</div>
		<!-- /.navigation -->
