			...
			<div class="col-xs-12">
				<div class="box-content">
					...
					<table id="example-row-grouping" class="table table-striped table-bordered display" style="width:100%">
						...
						<tbody>
							<?php
$rendezV = $bdd->prepare("SELECT * FROM  reservation INNER JOIN service ON service.Code = reservation.Code INNER JOIN client ON client.idclient = reservation.idclient INNER JOIN paiement ON paiement.idreservation = reservation.idreservation where client.idclient='$_SESSION[idclient]'"); 
$rendezV->execute();
							...
							<tr>
								...
								<td>
									<?php if ($liste['Etat']=='0') {?>
										...
										Encours<br>
										<a type="button" href="" class="btn btn-primary btn-xs waves-effect waves-light">Annuel</a>
									<?php }else {?>
										Déjà valider
									<?php }
