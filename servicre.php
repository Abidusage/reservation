...
include('Action/reservationClient.php');
				...
				<div class="box-content card white">
					...
					<div class="card-content">
						<form action="" method="POST" enctype="multipart/form-data">
				            ...
				            <div class="form-group">
								<label for="exampleInputEmail1">Numéro se jours</label>
							...
							<div class="form-group">
								<label for="exampleInputPassword1">Date d'arriver</label>
								<input type="Date" class="form-control" name="Datearrive" id="exampleInputPassword1" placeholder="Prix ... !">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">Date de part </label>
								<input type="Date" class="form-control" name="datedapart" id="exampleInputPassword1" placeholder="Prix ... !">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">Mdifier de la réservation </label>
								<textarea class="form-control" name="motoifsejour" id="exampleInputPassword1" placeholder="Prix ... !"></textarea>
							</div>
							<?php
                                    if($erreurLogin!=""){?>
                                    <h4><strong>     
                                ...
                                <?php   } ?>
				            <button type="submit" name="payer" class="btn btn-primary btn-xs waves-effect waves-light">Réservation</button>
						</form>
					</div>
					<!-- /.card-content -->
				</div>
